  ...
  return (
    <div className="flex justify-between items-center lg:flex-row flex-col gap-4 my-8">
      ...
      <div className="relative bg-[linear-gradient(125.07deg,rgba(99,46,227,1),rgba(159,98,242,1))] w-1/2 px-10 py-14 text-center rounded-lg overflow-hidden">
        <div className="absolute md:top-0 left-0 w-full h-full bg-no-repeat bg-contain bg-[url('/vector1.png')]"></div>

        <div className="absolute md:bottom-0 right-0  w-full h-full transform scale-x-[-1]  bg-no-repeat bg-contain bg-[url('/vector2.png')]"></div>
